...
// Use CORS middleware
app.use(cors({
    origin: '*',  // Allows all origins. Adjust this to be more restrictive in production.
...
app.post('/answer', (req, res) => {
    ...
    if (!userQuestion) {
        return res.status(422).json({ error: 'User question is required' });
    }

    // Handle the user question here
    const answer = `This is the answer to: ${userQuestion}`;
